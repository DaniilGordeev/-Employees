...
class Main(tk.Frame):
    ...
    def init_main(self): #Добавление всех значков и их функционал, также заполнение интерфейса приложения 
...
class Child(tk.Toplevel): #Создание окна для заполнения данных в таблицу 
    def __init__(self):
        super().__init__(root)
        self.init_child()
        self.view = app
...
class Update(Child): #Создание окна для редактирования данных пользователей внесенных в таблицу 
    def __init__(self):
        super().__init__()
        self.init_edit()
        self.view = app
...
class Search(tk.Toplevel): #Создание окна для поиска сотрудников по имени, а также обработка данного действия 
    def __init__(self):
        super().__init__()
        self.init_search()
        self.view = app
...
if __name__ == "__main__": #Создание приложения
    root = tk.Tk()
    db = DB()
    app = Main(root)
    app.pack()
